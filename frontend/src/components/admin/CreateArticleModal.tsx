 ...
 * Form for creating new articles with validation
 */
...
import { articleService, ArticleCategory, ArticleStatus } from "@/services/article.service";
  ...
  const onSubmit = async (data: ArticleFormData) => {
    try {
      ...
      toast({
        ...
        description: `Your article "${data.title}" has been ${data.status === "published" ? "published" : "saved as draft"}.`,
      });
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Fill in the details to create a new article. All required fields must be
            completed.
          </DialogDescription>
        </DialogHeader>
