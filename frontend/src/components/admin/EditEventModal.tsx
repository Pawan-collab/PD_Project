 ...
 * Form for editing existing events with validation
 */
...
export default function EditEventModal({
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      await eventService.updateEvent(event._id, data);
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Update the event details. All required fields must be completed.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <Label htmlFor="kind">
                Event Kind <span className="text-red-500">*</span>
              </Label>
              <Controller
                name="kind"
                control={control}
