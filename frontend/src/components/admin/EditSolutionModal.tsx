...
export default function EditSolutionModal({
  ...
  useEffect(() => {
    if (solution && open) {
      reset({
        ...
        badge: solution.badge || "none",
        color: solution.color || "primary",
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      await solutionService.updateSolution(solution._id, submit as any);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>Update solution details</DialogDescription>
        </DialogHeader>
