  ...
  const mockProjects = [
    {
      ...
      status: "Completed",
      description:
        "Comprehensive AI-powered healthcare management system with predictive analytics, patient monitoring, and automated diagnosis assistance.",
      results: [
    ...
    },
    {
      ...
      status: "Completed",
      description:
        "End-to-end automation platform for loan processing, risk assessment, and compliance monitoring with real-time fraud detection.",
      results: [
    ...
    },
    {
      ...
      status: "Completed",
      description:
        "IoT-integrated AI system for predictive maintenance, quality control, and production optimization across multiple facilities.",
      results: [
    ...
    },
    {
      ...
      status: "In Progress",
      description:
        "AI-driven customer experience platform with personalized recommendations, inventory optimization, and omnichannel integration.",
      results: [
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Discover how leading organizations have transformed their
              ...
              <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                  {industries.map((industry, index) => (
                    <div
                      key={index}
                      className="flex items-center gap-2 p-3 bg-muted/20 rounded-lg hover:bg-muted/40 transition-colors cursor-pointer"
                    >
            ...
            <Card className="relative overflow-hidden glass-surface border-border/50">
              ...
              <CardContent className="relative p-8 text-center">
                ...
                <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                  Join the growing list of organizations that have transformed
                  their operations with our AI solutions. Let's discuss your
                  project today.
                </p>
                <Button
                  size="lg"
