    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div
            className="absolute bottom-20 right-10 w-96 h-96 bg-secondary/5 rounded-full blur-3xl animate-float-gentle"
        ...
        <div className="relative z-10 text-center max-w-6xl mx-auto px-6">
          ...
          <p
            className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-4xl mx-auto leading-relaxed animate-fade-up"
            style={{ animationDelay: "0.2s" }}
          >
            AI Solutions delivers cutting-edge AI solutions that revolutionize
            digital employee experiences, automate complex workflows, and drive
          ...
          >
            <Link to="/home">
              <Button
                size="xl"
                className="group bg-gradient-primary hover:shadow-glow px-8 py-6 text-lg"
              >
                Explore Platform
          ...
          {/* Stats */}
          <div
            className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20 animate-fade-up"
            ...
            {[
              {
                ...
                description:
                  "Advanced machine learning algorithms that adapt and improve with your business needs.",
              },
              {
                icon: Zap,
                title: "Lightning Fast",
                description:
                  "Real-time processing and instant responses that keep your operations running smoothly.",
              },
              {
                icon: Shield,
                title: "Enterprise Security",
                description:
                  "Bank-level security protocols protecting your data with military-grade encryption.",
              },
              {
                icon: Sparkles,
                title: "Seamless Integration",
                description:
                  "Easy integration with existing systems through our comprehensive API ecosystem.",
              },
            ].map((feature, index) => (
              <Card
                key={index}
            ...
            <Card className="relative glass-surface border-border/50 p-12">
              <CardContent className="p-0">
                ...
                <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
                  Join thousands of companies already using AI Solutions to
                  revolutionize their operations with AI-powered solutions.
                </p>
